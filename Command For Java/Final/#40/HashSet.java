...
public class HashSet
{
   ...
   */
   ...
   public HashSet intersect(HashSet first, HashSet second)
   {
    HashSet intersectx = new HashSet(buckets.length);
    HashSet intersecty = new HashSet(buckets.length);
    ...
    Iterator zoom2 = intersecty.iterator();

    while (zoom2.hasNext()) {
        Object y =zoom2.next();
        if(second.contains(y)) {
            intersectx.add(y);
        }
    }
    return intersectx;
